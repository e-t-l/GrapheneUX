...
1. Install, pair, and start [Shizuku](https://github.com/thedjchi/Shizuku). ([Instructions](https://github.com/e-t-l/GrapheneUX/blob/main/Shizuku%20system%20privileges.md))
