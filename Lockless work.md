...
1. In **Settings app > Security & Privacy > More Security & Privacy**, disable "Work profile: Use one lock." (This will require you to set a separate PIN or password for the work profile; it doesn't matter since you will be disabling it immediately, so a PIN of `0000` is fine, for example.)
